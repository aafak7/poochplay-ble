...
public class HeartBleService extends Service {
    public static final String TAG = HeartBleService.class.getSimpleName();
    ...
    String value;
    public static final String ACTION_GATT_CONNECTED = "com.heart.ble.ACTION_GATT_CONNECTED";
    public static final String ACTION_GATT_DISCONNECTED = "com.heart.blei.ACTION_GATT_DISCONNECTED";
    public static final String ACTION_GATT_SERVICES_DISCOVERED = "com.heart.ble.ACTION_GATT_SERVICES_DISCOVERED";
    public static final String ACTION_DATA_AVAILABLE = "com.heart.ble.ACTION_DATA_AVAILABLE";
    public static final String EXTRA_DATA = "com.heart.ble.ui.EXTRA_DATA";
    ...
    public final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            String intentAction;
            if (newState == 2) {
                intentAction = "com.heart.ble.ACTION_GATT_CONNECTED";
                HeartBleService.this.mConnectionState = 2;
                HeartBleService.this.broadcastUpdate(intentAction);
                Log.i("ly", "发广播ACTION_GATT_CONNECTED");
                Log.i(HeartBleService.TAG, "Connected to GATT server.");
                Log.i(HeartBleService.TAG, "Attempting to start service discovery:" + HeartBleService.this.mBluetoothGatt.discoverServices());
            } else if (newState == 0) {
                intentAction = "com.heart.blei.ACTION_GATT_DISCONNECTED";
                HeartBleService.this.mConnectionState = 0;
                Log.i(HeartBleService.TAG, "Disconnected from GATT server.");
                HeartBleService.this.broadcastUpdate(intentAction);
            }
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == 0) {
                HeartBleService.this.broadcastUpdate("com.heart.ble.ACTION_GATT_SERVICES_DISCOVERED");
            } else {
                Log.w(HeartBleService.TAG, "onServicesDiscovered received: " + status);
            }
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            if (status == 0) {
                HeartBleService.this.broadcastUpdate("com.heart.ble.ACTION_DATA_AVAILABLE", characteristic);
            }
    ...
    public void broadcastUpdate(String action, BluetoothGattCharacteristic characteristic) {
        ...
        if (data != null && data.length > 0) {
            ...
            intent.putExtra("com.heart.ble.ui.EXTRA_DATA", stringBuilder.toString());
    ...
    public class LocalBinder extends Binder {
        ...
        public HeartBleService getService() {
