...
public class ProtocolTimerManager {
    ...
    private static int ProtocolFindTimer(TimerPara tmpTimerPara) {
        int offset = 0;
    ...
    public static void ProtocolTimerStart(TimerPara tmpTimerPara, boolean isReload) {
        lock.lock();
        TimerList log_cur = timer_list_first;
        int offset = ProtocolFindTimer(tmpTimerPara);
    ...
    public static void ProtocolTimerStop(TimerPara tmpTimerPara) {
        lock.lock();
    ...
    public static void ProcotolTimerUpdate(int updatetime) {
        int timercnt = 0;
        lock.lock();
        TimerList pre = null;
        TimerList cur = timer_list_first;
